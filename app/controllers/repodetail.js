		...
		if(err){
			...
			var xhr = Titanium.Network.createHTTPClient({
				onload: function() {
					...
					var ftmp = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory,"filetmp.jpeg");
					...
					*/
					var writeOk = ftmp.write(this.responseData);
					var imgBlobTmp = ftmp.read();
					var imgBlob = Alloy.Globals.resizePhoto(imgBlobTmp);
					var f = Ti.Filesystem.getFile(Ti.Filesystem.applicationDataDirectory, newFileName);
					writeOK = f.write(imgBlob);
			...
			xhr.setRequestHeader("Accept", "application/octect-stream");
